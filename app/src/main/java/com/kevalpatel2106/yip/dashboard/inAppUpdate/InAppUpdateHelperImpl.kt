...
internal class InAppUpdateHelperImpl @Inject constructor(
    private val prefsProvider: SharedPrefsProvider
) : InAppUpdateHelper {
    override fun isUpdateDownloaded(state: InstallState): Boolean {
    ...
    override fun resetUpdateInfoAskedTime() {
